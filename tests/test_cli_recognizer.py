...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["coverage-pipeline", "preview", "--checklist-tsv", "species.tsv"], {"command": "coverage-pipeline", "subcommand": "preview", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["coverage-pipeline", "build", "--checklist-tsv", "species.tsv", "--write", "--outdir", "pipeline"], {"command": "coverage-pipeline", "subcommand": "build", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": True, "requires_outdir": True}),
        (["coverage-pipeline", "status", "--coverage-pipeline-dir", "pipeline"], {"command": "coverage-pipeline", "subcommand": "status", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["coverage-pipeline", "server-validation-result", "review-queue", "--input", "result.json", "--write", "--out", "queue.tsv"], {"command": "coverage-pipeline", "subcommand": "server-validation-result review-queue", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": True, "requires_outdir": False}),
        (["coverage-pipeline", "server-validation-result", "triage-queue", "--input", "queue.tsv", "--write", "--out", "triage.tsv"], {"command": "coverage-pipeline", "subcommand": "server-validation-result triage-queue", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": True, "requires_outdir": False}),
        (["coverage-pipeline", "server-validation-result", "quality-review", "--triage", "triage.tsv", "--decisions", "decisions.tsv", "--write", "--outdir", "quality"], {"command": "coverage-pipeline", "subcommand": "server-validation-result quality-review", "mode": "coverage_pipeline", "is_coverage_pipeline": True, "writes_outputs_declared": True, "requires_outdir": False}),
        (["selection-review", "strategy", "--outdir", "run"], {"command": "selection-review", "subcommand": "strategy", "mode": "selection_review", "is_selection_review": True, "writes_outputs_declared": False, "requires_outdir": True}),
        (["download-smoke", "inspect", "--download-plan", "bounded.tsv", "--write", "--outdir", "inspection"], {"command": "download-smoke", "subcommand": "inspect", "mode": "download_smoke", "is_download_smoke": True, "writes_outputs_declared": True, "requires_outdir": True}),
        (["download-smoke", "execute", "--commands-manifest", "commands.tsv", "--write", "--outdir", "execution"], {"command": "download-smoke", "subcommand": "execute", "mode": "download_smoke", "is_download_smoke": True, "writes_outputs_declared": True, "requires_outdir": True}),
        ...
        (["provider-request", "validate", "--input", "provider_request.tsv"], {"command": "provider-request", "subcommand": "validate", "mode": "provider_request", "is_provider_request": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["provider-request", "external-genomes-draft", "--input", "provider_request.tsv"], {"command": "provider-request", "subcommand": "external-genomes-draft", "mode": "provider_request", "is_provider_request": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["provider-request", "external-genomes-draft", "--input", "provider_request.tsv", "--write", "--outdir", "external"], {"command": "provider-request", "subcommand": "external-genomes-draft", "mode": "provider_request", "is_provider_request": True, "writes_outputs_declared": True, "requires_outdir": True}),
        (["provider-request", "external-genomes-handoff", "--input", "provider_request.tsv"], {"command": "provider-request", "subcommand": "external-genomes-handoff", "mode": "provider_request", "is_provider_request": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["provider-request", "external-genomes-handoff", "--input", "provider_request.tsv", "--write", "--outdir", "handoff"], {"command": "provider-request", "subcommand": "external-genomes-handoff", "mode": "provider_request", "is_provider_request": True, "writes_outputs_declared": True, "requires_outdir": True}),
        (["external-genomes", "validate", "--input", "external_genomes.tsv"], {"command": "external-genomes", "subcommand": "validate", "mode": "external_genomes", "is_external_genomes": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["external-genomes", "install-plan", "--input", "external_genomes.tsv", "--target-outdir", "run"], {"command": "external-genomes", "subcommand": "install-plan", "mode": "external_genomes", "is_external_genomes": True, "writes_outputs_declared": False, "requires_outdir": False}),
        (["external-genomes", "install-plan", "--input", "external_genomes.tsv", "--target-outdir", "run", "--write", "--outdir", "plan"], {"command": "external-genomes", "subcommand": "install-plan", "mode": "external_genomes", "is_external_genomes": True, "writes_outputs_declared": True, "requires_outdir": True}),
