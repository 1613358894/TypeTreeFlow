...
counts, optional quality-gate passed/blocked rows, controlled blocker counts,
and controlled quality-gate recommendation labels/reasons. The fragmentation
quality profile is only a shorthand for
