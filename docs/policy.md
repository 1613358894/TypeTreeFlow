...
provider registry, with plain strain codes filtered where possible, but they
must not be reinterpreted as provider support, provider handoff rows, download
readiness, or strict scientific evidence.
...
NRRL, NCAIM, HAMBI, KMM, GTC, PAGU, BCRC, CCRC, NCCB, CSUR/Marseille, TBRC, TISTR, CICC, IFO, IAM,
FERM, KCCM, and NCCP,
