...
DSMZ, ATCC, JCM, NCTC, CGMCC, NBRC/NITE, KCTC, KACC, VKM, MCCC, GDMCC,
CCTCC, CECT, CIP, CCUG, CCM, BCCM/LMG, NCIMB, NCIB, NRRL, NCAIM, HAMBI,
KMM, GTC, PAGU, BCRC, CCRC, NCCB, CSUR, CICC, IFO, IAM, FERM, KCCM, and
NCCP,
