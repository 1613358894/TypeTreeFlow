...
- Follow the commit and CI hygiene rules in `../docs/development.md`.
- Add or update tests for behavior changes.
- Update `../README.md`, `../docs/`, or `../CHANGELOG.md` when user-visible behavior
  changes.
- Use `../docs/index.md` to decide which documentation contract, design, policy,
  or release note needs updating.
...
See `../docs/development.md` for the fuller release validation workflow.
